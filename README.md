...
- **LAYER.1** Inner layers never import outer layers: the layer order is Entities → Use-Cases → Adapters → Services, and an import against it is a violation regardless of path form.
