...
// The one declared option and its convention default; aliases, the ownership tree, and the shared floors are derived (tree.js), never declared.
export const OPTION_DEFAULTS = { compositionRoot: 'routes' };
